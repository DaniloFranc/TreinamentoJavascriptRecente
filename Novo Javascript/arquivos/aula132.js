...
const parciaisresgistradas=document.querySelector('#parciaisresgistradas')
...
const contador=()=>{
    ...
    let seg=(tmpatual-tmpini)/1000 //floor arredonda o número
...
btn_parcial.addEventListener('click',(evt)=>{
    ...
    parciaisresgistradas.innerHTML+=parcial
})
...
btn_zerar.addEventListener('click',(evt)=>{
    ...
    clearInterval(intervalo)
    parciaisresgistradas.innerHTML=""
